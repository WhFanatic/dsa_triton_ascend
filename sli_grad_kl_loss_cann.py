...
_ACLNN_WORKSPACE_SIGNATURE = (
    ...
    "const aclTensor* weights, const aclTensor* sparseIndices, "
    "const aclTensor* softmaxMax, const aclTensor* softmaxSum, "
    "const aclTensor* queryRope, const aclTensor* keyRope, "
    "const aclIntArray* actualSeqQlen, const aclIntArray* actualSeqKlen, "
    "double scaleValue, const char* layout, "
...
def _build_reg_info():
    ...
    return CustomRegOp("aclnnSparseLightningIndexerGradKLLoss") \
        ...
        .dtype_format(
            ...
            DataType.BF16_Default, DataType.BF16_Default,
            DataType.BF16_Default, DataType.I32_Default,
            DataType.F32_Default, DataType.F32_Default,
            DataType.BF16_Default, DataType.BF16_Default,
            DataType.BF16_Default, DataType.BF16_Default,
